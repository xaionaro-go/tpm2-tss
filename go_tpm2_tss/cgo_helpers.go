...
func (x *Tss2TctiInfo) PassRef() (*C.TSS2_TCTI_INFO, *cgoAllocMap) {
	...
	ref39dad98b.name, cname_allocs = *(**C.char)(unsafe.Pointer(&x.Name)), cgoAllocsUnknown
	allocs39dad98b.Borrow(cname_allocs)

	var cdescription_allocs *cgoAllocMap
	ref39dad98b.description, cdescription_allocs = *(**C.char)(unsafe.Pointer(&x.Description)), cgoAllocsUnknown
	allocs39dad98b.Borrow(cdescription_allocs)

	var cconfig_help_allocs *cgoAllocMap
	ref39dad98b.config_help, cconfig_help_allocs = *(**C.char)(unsafe.Pointer(&x.ConfigHelp)), cgoAllocsUnknown
	allocs39dad98b.Borrow(cconfig_help_allocs)

	var cinit_allocs *cgoAllocMap
	ref39dad98b.init, cinit_allocs = (*[0]byte)(unsafe.Pointer(&x.Init)), cgoAllocsUnknown
...
func (x *Tss2TctiInfo) Deref() {
	...
	x.Name = packPCharString(x.ref39dad98b.name)
	x.Description = packPCharString(x.ref39dad98b.description)
	x.ConfigHelp = packPCharString(x.ref39dad98b.config_help)
	// x.Init is a callback func
}
...
func tss2TctiInfoFunc3AB67CD0() *C.TSS2_TCTI_INFO {
	if tss2TctiInfoFunc3AB67CD0Func != nil {
		...
		hdr := &sliceHeader{Data: unsafe.Pointer(ret3ab67cd0)}
		if ret3ab67cd0 != nil {
			hdr.Len = 1
			hdr.Cap = 1
		}
		ret, _ := unpackArgSTss2TctiInfo(*(*[]Tss2TctiInfo)((unsafe.Pointer)(hdr)))
		return ret
	}
	panic("callback func has not been set (race?)")
}
