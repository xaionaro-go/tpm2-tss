...
func fapiCbAuth4BC69268(cobjectpath *C.char, cdescription *C.char, cauth **C.char, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbAuth4BC69268Func != nil {
		var objectpath4bc69268 []string
		packSString(objectpath4bc69268, cobjectpath)
		var description4bc69268 []string
		packSString(description4bc69268, cdescription)
		var auth4bc69268 [][]string
		packSSString(auth4bc69268, cauth)
		userdata4bc69268 := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		ret4bc69268 := fapiCbAuth4BC69268Func(objectpath4bc69268, description4bc69268, auth4bc69268, userdata4bc69268)
...
func fapiCbBranchA8BBEE51(cobjectpath *C.char, cdescription *C.char, cbranchnames **C.char, cnumbranches C.size_t, cselectedbranch *C.size_t, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbBranchA8BBEE51Func != nil {
		var objectpatha8bbee51 []string
		packSString(objectpatha8bbee51, cobjectpath)
		...
		hxf058b18 := (*sliceHeader)(unsafe.Pointer(&selectedbrancha8bbee51))
		hxf058b18.Data = unsafe.Pointer(cselectedbranch)
		hxf058b18.Cap = 0x7fffffff
		// hxf058b18.Len = ?

		userdataa8bbee51 := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		reta8bbee51 := fapiCbBranchA8BBEE51Func(objectpatha8bbee51, descriptiona8bbee51, branchnamesa8bbee51, numbranchesa8bbee51, selectedbrancha8bbee51, userdataa8bbee51)
...
func fapiCbSign2C66B3CF(cobjectpath *C.char, cdescription *C.char, cpublickey *C.char, cpublickeyhint *C.char, chashalg C.uint32_t, cdatatosign *C.uint8_t, cdatatosignsize C.size_t, csignature **C.uint8_t, csignaturesize *C.size_t, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbSign2C66B3CFFunc != nil {
		var objectpath2c66b3cf []string
		packSString(objectpath2c66b3cf, cobjectpath)
		...
		hxff6bc57 := (*sliceHeader)(unsafe.Pointer(&datatosign2c66b3cf))
		hxff6bc57.Data = unsafe.Pointer(cdatatosign)
		...
		hxf21690b := (*sliceHeader)(unsafe.Pointer(&signaturesize2c66b3cf))
		hxf21690b.Data = unsafe.Pointer(csignaturesize)
		hxf21690b.Cap = 0x7fffffff
		// hxf21690b.Len = ?

		userdata2c66b3cf := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		ret2c66b3cf := fapiCbSign2C66B3CFFunc(objectpath2c66b3cf, description2c66b3cf, publickey2c66b3cf, publickeyhint2c66b3cf, hashalg2c66b3cf, datatosign2c66b3cf, datatosignsize2c66b3cf, signature2c66b3cf, signaturesize2c66b3cf, userdata2c66b3cf)
...
func fapiCbPolicyactionD83965A7(cobjectpath *C.char, caction *C.char, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbPolicyactionD83965A7Func != nil {
		var objectpathd83965a7 []string
		packSString(objectpathd83965a7, cobjectpath)
		var actiond83965a7 []string
		packSString(actiond83965a7, caction)
		userdatad83965a7 := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		retd83965a7 := fapiCbPolicyactionD83965A7Func(objectpathd83965a7, actiond83965a7, userdatad83965a7)
...
func (x *RandomData) Deref() {
	...
	hxf1231c9 := (*sliceHeader)(unsafe.Pointer(&x.Fptr))
	hxf1231c9.Data = unsafe.Pointer(x.refb9fde78.fptr)
	hxf1231c9.Cap = 0x7fffffff
	// hxf1231c9.Len = ?

	hxf04b15b := (*sliceHeader)(unsafe.Pointer(&x.Rptr))
	hxf04b15b.Data = unsafe.Pointer(x.refb9fde78.rptr)
	hxf04b15b.Cap = 0x7fffffff
	// hxf04b15b.Len = ?

	hxf2f888b := (*sliceHeader)(unsafe.Pointer(&x.State))
	hxf2f888b.Data = unsafe.Pointer(x.refb9fde78.state)
	...
	hxf5d1de2 := (*sliceHeader)(unsafe.Pointer(&x.EndPtr))
	hxf5d1de2.Data = unsafe.Pointer(x.refb9fde78.end_ptr)
...
func packSSFapiContext(v [][]FapiContext, ptr0 **C.FAPI_CONTEXT) {
	...
	for i0 := range v {
		...
		hxff24242 := (*sliceHeader)(unsafe.Pointer(&v[i0]))
		hxff24242.Data = unsafe.Pointer(ptr1)
...
func packSS_GwcharT(v [][]_GwcharT, ptr0 **C.__gwchar_t) {
	...
	for i0 := range v {
		...
		hxfe21083 := (*sliceHeader)(unsafe.Pointer(&v[i0]))
		hxfe21083.Data = unsafe.Pointer(ptr1)
