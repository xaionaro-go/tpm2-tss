...
// New_FsidTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func New_FsidTRef(ref unsafe.Pointer) *_FsidT {
	if ref == nil {
		return nil
	}
	obj := new(_FsidT)
...
// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *_FsidT) PassRef() (*C.__fsid_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref3fddfece != nil {
		return x.ref3fddfece, nil
	}
	mem3fddfece := alloc_FsidTMemory(1)
	...
	ref3fddfece.__val, c__val_allocs = *(*[2]C.int)(unsafe.Pointer(&x._Val)), cgoAllocsUnknown
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x _FsidT) PassValue() (C.__fsid_t, *cgoAllocMap) {
...
func (x *_FsidT) Deref() {
	...
	x._Val = *(*[2]int32)(unsafe.Pointer(&x.ref3fddfece.__val))
}
...
func packSString(v []string, ptr0 *C.char) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfCharValue]C.char)(unsafe.Pointer(ptr0)))[i0]
...
func (x *Tss2TctiInfo) Ref() *C.TSS2_TCTI_INFO {
	...
	return x.ref39dad98b
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Tss2TctiInfo) Free() {
	if x != nil && x.allocs39dad98b != nil {
		x.allocs39dad98b.(*cgoAllocMap).Free()
		x.ref39dad98b = nil
	}
}

// NewTss2TctiInfoRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewTss2TctiInfoRef(ref unsafe.Pointer) *Tss2TctiInfo {
	if ref == nil {
		return nil
	}
	obj := new(Tss2TctiInfo)
	obj.ref39dad98b = (*C.TSS2_TCTI_INFO)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Tss2TctiInfo) PassRef() (*C.TSS2_TCTI_INFO, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref39dad98b != nil {
		return x.ref39dad98b, nil
	}
	mem39dad98b := allocTss2TctiInfoMemory(1)
	ref39dad98b := (*C.TSS2_TCTI_INFO)(mem39dad98b)
	allocs39dad98b := new(cgoAllocMap)
	allocs39dad98b.Add(mem39dad98b)

	var cversion_allocs *cgoAllocMap
	ref39dad98b.version, cversion_allocs = (C.uint32_t)(x.Version), cgoAllocsUnknown
	allocs39dad98b.Borrow(cversion_allocs)

	var cname_allocs *cgoAllocMap
	ref39dad98b.name, cname_allocs = unpackSString(x.Name)
	allocs39dad98b.Borrow(cname_allocs)

	var cdescription_allocs *cgoAllocMap
	ref39dad98b.description, cdescription_allocs = unpackSString(x.Description)
	allocs39dad98b.Borrow(cdescription_allocs)

	var cconfig_help_allocs *cgoAllocMap
	ref39dad98b.config_help, cconfig_help_allocs = unpackSString(x.ConfigHelp)
	allocs39dad98b.Borrow(cconfig_help_allocs)

	var cinit_allocs *cgoAllocMap
	ref39dad98b.init, cinit_allocs = x.Init.PassValue()
	allocs39dad98b.Borrow(cinit_allocs)

	x.ref39dad98b = ref39dad98b
	x.allocs39dad98b = allocs39dad98b
	return ref39dad98b, allocs39dad98b

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Tss2TctiInfo) PassValue() (C.TSS2_TCTI_INFO, *cgoAllocMap) {
	if x.ref39dad98b != nil {
		return *x.ref39dad98b, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *Tss2TctiInfo) Deref() {
	if x.ref39dad98b == nil {
		return
	}
	x.Version = (Uint32T)(x.ref39dad98b.version)
	packSString(x.Name, x.ref39dad98b.name)
	packSString(x.Description, x.ref39dad98b.description)
	packSString(x.ConfigHelp, x.ref39dad98b.config_help)
	x.Init = *NewTss2TctiInitFuncRef(unsafe.Pointer(&x.ref39dad98b.init))
}

// unpackArgSTss2TctiInfo transforms a sliced Go data structure into plain C format.
func unpackArgSTss2TctiInfo(x []Tss2TctiInfo) (unpacked *C.TSS2_TCTI_INFO, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocTss2TctiInfoMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
...
func tss2TctiInfoFunc3AB67CD0() *C.TSS2_TCTI_INFO {
	if tss2TctiInfoFunc3AB67CD0Func != nil {
		...
		ret, _ := unpackArgSTss2TctiInfo(ret3ab67cd0)
		return ret
	}
	panic("callback func has not been set (race?)")
}
...
func (x *Private) Ref() *C._PRIVATE {
	...
	return x.ref990bdeb6
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Private) Free() {
	if x != nil && x.allocs990bdeb6 != nil {
		x.allocs990bdeb6.(*cgoAllocMap).Free()
		x.ref990bdeb6 = nil
	}
}

// NewPrivateRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewPrivateRef(ref unsafe.Pointer) *Private {
	...
	obj := new(Private)
	obj.ref990bdeb6 = (*C._PRIVATE)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Private) PassRef() (*C._PRIVATE, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref990bdeb6 != nil {
		return x.ref990bdeb6, nil
	}
	mem990bdeb6 := allocPrivateMemory(1)
	ref990bdeb6 := (*C._PRIVATE)(mem990bdeb6)
	allocs990bdeb6 := new(cgoAllocMap)
	allocs990bdeb6.Add(mem990bdeb6)

	var cintegrityOuter_allocs *cgoAllocMap
	ref990bdeb6.integrityOuter, cintegrityOuter_allocs = x.Integrityouter.PassValue()
	allocs990bdeb6.Borrow(cintegrityOuter_allocs)

	var cintegrityInner_allocs *cgoAllocMap
	ref990bdeb6.integrityInner, cintegrityInner_allocs = x.Integrityinner.PassValue()
	allocs990bdeb6.Borrow(cintegrityInner_allocs)

	var csensitive_allocs *cgoAllocMap
	ref990bdeb6.sensitive, csensitive_allocs = x.Sensitive.PassValue()
	allocs990bdeb6.Borrow(csensitive_allocs)

	x.ref990bdeb6 = ref990bdeb6
	x.allocs990bdeb6 = allocs990bdeb6
	return ref990bdeb6, allocs990bdeb6

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Private) PassValue() (C._PRIVATE, *cgoAllocMap) {
	if x.ref990bdeb6 != nil {
		return *x.ref990bdeb6, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *Private) Deref() {
	if x.ref990bdeb6 == nil {
		return
	}
	x.Integrityouter = *NewTpm2bDigestRef(unsafe.Pointer(&x.ref990bdeb6.integrityOuter))
	x.Integrityinner = *NewTpm2bDigestRef(unsafe.Pointer(&x.ref990bdeb6.integrityInner))
	x.Sensitive = *NewTpm2bSensitiveRef(unsafe.Pointer(&x.ref990bdeb6.sensitive))
}
...
// Ref returns a reference to C object as it is.
func (x *FapiContext) Ref() *C.FAPI_CONTEXT {
	if x == nil {
		return nil
	}
	return (*C.FAPI_CONTEXT)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *FapiContext) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewFapiContextRef converts the C object reference into a raw struct reference without wrapping.
func NewFapiContextRef(ref unsafe.Pointer) *FapiContext {
	return (*FapiContext)(ref)
}

// NewFapiContext allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewFapiContext() *FapiContext {
	return (*FapiContext)(allocFapiContextMemory(1))
}

// allocFapiContextMemory allocates memory for type C.FAPI_CONTEXT in C.
// The caller is responsible for freeing the this memory via C.free.
func allocFapiContextMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfFapiContextValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfFapiContextValue = unsafe.Sizeof([1]C.FAPI_CONTEXT{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *FapiContext) PassRef() *C.FAPI_CONTEXT {
	if x == nil {
		x = (*FapiContext)(allocFapiContextMemory(1))
	}
	return (*C.FAPI_CONTEXT)(unsafe.Pointer(x))
}
...
func (x FapiCbAuth) PassRef() (ref *C.Fapi_CB_Auth, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if fapiCbAuth4BC69268Func == nil {
		fapiCbAuth4BC69268Func = x
	}
	return (*C.Fapi_CB_Auth)(C.Fapi_CB_Auth_4bc69268), nil
}

func (x FapiCbAuth) PassValue() (ref C.Fapi_CB_Auth, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if fapiCbAuth4BC69268Func == nil {
...
func NewFapiCbAuthRef(ref unsafe.Pointer) *FapiCbAuth {
	return (*FapiCbAuth)(ref)
}

//export fapiCbAuth4BC69268
func fapiCbAuth4BC69268(ccontext *C.FAPI_CONTEXT, cdescription *C.char, cauth **C.char, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbAuth4BC69268Func != nil {
		var context4bc69268 []FapiContext
		hxf058b18 := (*sliceHeader)(unsafe.Pointer(&context4bc69268))
		hxf058b18.Data = unsafe.Pointer(ccontext)
		hxf058b18.Cap = 0x7fffffff
		// hxf058b18.Len = ?

		var description4bc69268 []string
		packSString(description4bc69268, cdescription)
		var auth4bc69268 [][]byte
		packSSByte(auth4bc69268, cauth)
		userdata4bc69268 := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		ret4bc69268 := fapiCbAuth4BC69268Func(context4bc69268, description4bc69268, auth4bc69268, userdata4bc69268)
		ret, _ := (C.TSS2_RC)(ret4bc69268), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}

var fapiCbAuth4BC69268Func FapiCbAuth
...
func packSSString(v [][]string, ptr0 **C.char) {
	...
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]*C.char)(unsafe.Pointer(ptr0)))[i0]
		for i1 := range v[i0] {
			ptr2 := (*(*[m / sizeOfCharValue]C.char)(unsafe.Pointer(ptr1)))[i1]
			v[i0][i1] = packPCharString(ptr2)
		}
	}
}

func (x FapiCbBranch) PassRef() (ref *C.Fapi_CB_Branch, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if fapiCbBranchA8BBEE51Func == nil {
		fapiCbBranchA8BBEE51Func = x
	}
	return (*C.Fapi_CB_Branch)(C.Fapi_CB_Branch_a8bbee51), nil
}

func (x FapiCbBranch) PassValue() (ref C.Fapi_CB_Branch, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if fapiCbBranchA8BBEE51Func == nil {
...
func NewFapiCbBranchRef(ref unsafe.Pointer) *FapiCbBranch {
	return (*FapiCbBranch)(ref)
}

//export fapiCbBranchA8BBEE51
func fapiCbBranchA8BBEE51(ccontext *C.FAPI_CONTEXT, cdescription *C.char, cbranchnames **C.char, cnumbranches C.size_t, cselectedbranch *C.size_t, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbBranchA8BBEE51Func != nil {
		var contexta8bbee51 []FapiContext
		hxf5fa529 := (*sliceHeader)(unsafe.Pointer(&contexta8bbee51))
		hxf5fa529.Data = unsafe.Pointer(ccontext)
		hxf5fa529.Cap = 0x7fffffff
		// hxf5fa529.Len = ?

		var descriptiona8bbee51 []string
		packSString(descriptiona8bbee51, cdescription)
		var branchnamesa8bbee51 [][]string
		packSSString(branchnamesa8bbee51, cbranchnames)
		numbranchesa8bbee51 := (SizeT)(cnumbranches)
		var selectedbrancha8bbee51 []SizeT
		hxf21690b := (*sliceHeader)(unsafe.Pointer(&selectedbrancha8bbee51))
		hxf21690b.Data = unsafe.Pointer(cselectedbranch)
		hxf21690b.Cap = 0x7fffffff
		// hxf21690b.Len = ?

		userdataa8bbee51 := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		reta8bbee51 := fapiCbBranchA8BBEE51Func(contexta8bbee51, descriptiona8bbee51, branchnamesa8bbee51, numbranchesa8bbee51, selectedbrancha8bbee51, userdataa8bbee51)
		ret, _ := (C.TSS2_RC)(reta8bbee51), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}

var fapiCbBranchA8BBEE51Func FapiCbBranch
...
func (x FapiCbSign) PassRef() (ref *C.Fapi_CB_Sign, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if fapiCbSign2C66B3CFFunc == nil {
		fapiCbSign2C66B3CFFunc = x
	}
	return (*C.Fapi_CB_Sign)(C.Fapi_CB_Sign_2c66b3cf), nil
}

func (x FapiCbSign) PassValue() (ref C.Fapi_CB_Sign, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if fapiCbSign2C66B3CFFunc == nil {
...
func NewFapiCbSignRef(ref unsafe.Pointer) *FapiCbSign {
	return (*FapiCbSign)(ref)
}

//export fapiCbSign2C66B3CF
func fapiCbSign2C66B3CF(ccontext *C.FAPI_CONTEXT, cdescription *C.char, cpublickey *C.char, cpublickeyhint *C.char, chashalg C.uint32_t, cdatatosign *C.uint8_t, cdatatosignsize C.size_t, csignature **C.uint8_t, csignaturesize *C.size_t, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbSign2C66B3CFFunc != nil {
		var context2c66b3cf []FapiContext
		hxf1231c9 := (*sliceHeader)(unsafe.Pointer(&context2c66b3cf))
		hxf1231c9.Data = unsafe.Pointer(ccontext)
		hxf1231c9.Cap = 0x7fffffff
		// hxf1231c9.Len = ?

		var description2c66b3cf []string
		packSString(description2c66b3cf, cdescription)
		var publickey2c66b3cf []string
		packSString(publickey2c66b3cf, cpublickey)
		var publickeyhint2c66b3cf []string
		packSString(publickeyhint2c66b3cf, cpublickeyhint)
		hashalg2c66b3cf := (Uint32T)(chashalg)
		var datatosign2c66b3cf []Uint8T
		hxf04b15b := (*sliceHeader)(unsafe.Pointer(&datatosign2c66b3cf))
		hxf04b15b.Data = unsafe.Pointer(cdatatosign)
		hxf04b15b.Cap = 0x7fffffff
		// hxf04b15b.Len = ?

		datatosignsize2c66b3cf := (SizeT)(cdatatosignsize)
		var signature2c66b3cf [][]Uint8T
		packSSUint8T(signature2c66b3cf, csignature)
		var signaturesize2c66b3cf []SizeT
		hxf5d1de2 := (*sliceHeader)(unsafe.Pointer(&signaturesize2c66b3cf))
		hxf5d1de2.Data = unsafe.Pointer(csignaturesize)
		hxf5d1de2.Cap = 0x7fffffff
		// hxf5d1de2.Len = ?

		userdata2c66b3cf := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		ret2c66b3cf := fapiCbSign2C66B3CFFunc(context2c66b3cf, description2c66b3cf, publickey2c66b3cf, publickeyhint2c66b3cf, hashalg2c66b3cf, datatosign2c66b3cf, datatosignsize2c66b3cf, signature2c66b3cf, signaturesize2c66b3cf, userdata2c66b3cf)
		ret, _ := (C.TSS2_RC)(ret2c66b3cf), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}

var fapiCbSign2C66B3CFFunc FapiCbSign

func (x FapiCbPolicyaction) PassRef() (ref *C.Fapi_CB_PolicyAction, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if fapiCbPolicyactionD83965A7Func == nil {
		fapiCbPolicyactionD83965A7Func = x
	}
	return (*C.Fapi_CB_PolicyAction)(C.Fapi_CB_PolicyAction_d83965a7), nil
}

func (x FapiCbPolicyaction) PassValue() (ref C.Fapi_CB_PolicyAction, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if fapiCbPolicyactionD83965A7Func == nil {
...
func NewFapiCbPolicyactionRef(ref unsafe.Pointer) *FapiCbPolicyaction {
	return (*FapiCbPolicyaction)(ref)
}

//export fapiCbPolicyactionD83965A7
func fapiCbPolicyactionD83965A7(ccontext *C.FAPI_CONTEXT, caction *C.char, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbPolicyactionD83965A7Func != nil {
		var contextd83965a7 []FapiContext
		hxfe53d34 := (*sliceHeader)(unsafe.Pointer(&contextd83965a7))
		hxfe53d34.Data = unsafe.Pointer(ccontext)
		hxfe53d34.Cap = 0x7fffffff
		// hxfe53d34.Len = ?

		var actiond83965a7 []string
		packSString(actiond83965a7, caction)
		userdatad83965a7 := (unsafe.Pointer)(unsafe.Pointer(cuserdata))
		retd83965a7 := fapiCbPolicyactionD83965A7Func(contextd83965a7, actiond83965a7, userdatad83965a7)
		ret, _ := (C.TSS2_RC)(retd83965a7), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}

var fapiCbPolicyactionD83965A7Func FapiCbPolicyaction
...
func (x *DivT) Ref() *C.div_t {
	...
	return x.refd6897e45
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *DivT) Free() {
	if x != nil && x.allocsd6897e45 != nil {
		x.allocsd6897e45.(*cgoAllocMap).Free()
		x.refd6897e45 = nil
	}
}

// NewDivTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewDivTRef(ref unsafe.Pointer) *DivT {
	...
	obj := new(DivT)
	obj.refd6897e45 = (*C.div_t)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *DivT) PassRef() (*C.div_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refd6897e45 != nil {
		return x.refd6897e45, nil
	}
	memd6897e45 := allocDivTMemory(1)
	refd6897e45 := (*C.div_t)(memd6897e45)
	allocsd6897e45 := new(cgoAllocMap)
	allocsd6897e45.Add(memd6897e45)

	var cquot_allocs *cgoAllocMap
	refd6897e45.quot, cquot_allocs = (C.int)(x.Quot), cgoAllocsUnknown
	allocsd6897e45.Borrow(cquot_allocs)

	var crem_allocs *cgoAllocMap
	refd6897e45.rem, crem_allocs = (C.int)(x.Rem), cgoAllocsUnknown
	allocsd6897e45.Borrow(crem_allocs)

	x.refd6897e45 = refd6897e45
	x.allocsd6897e45 = allocsd6897e45
	return refd6897e45, allocsd6897e45

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x DivT) PassValue() (C.div_t, *cgoAllocMap) {
	if x.refd6897e45 != nil {
		return *x.refd6897e45, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
func (x *DivT) Deref() {
	...
	x.Quot = (int32)(x.refd6897e45.quot)
	x.Rem = (int32)(x.refd6897e45.rem)
}
...
func (x *LdivT) Ref() *C.ldiv_t {
	...
	return x.refde5fe7da
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *LdivT) Free() {
	if x != nil && x.allocsde5fe7da != nil {
		x.allocsde5fe7da.(*cgoAllocMap).Free()
		x.refde5fe7da = nil
	}
}

// NewLdivTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewLdivTRef(ref unsafe.Pointer) *LdivT {
	...
	obj := new(LdivT)
	obj.refde5fe7da = (*C.ldiv_t)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *LdivT) PassRef() (*C.ldiv_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refde5fe7da != nil {
		return x.refde5fe7da, nil
	}
	memde5fe7da := allocLdivTMemory(1)
	refde5fe7da := (*C.ldiv_t)(memde5fe7da)
	allocsde5fe7da := new(cgoAllocMap)
	allocsde5fe7da.Add(memde5fe7da)

	var cquot_allocs *cgoAllocMap
	refde5fe7da.quot, cquot_allocs = (C.long)(x.Quot), cgoAllocsUnknown
	allocsde5fe7da.Borrow(cquot_allocs)

	var crem_allocs *cgoAllocMap
	refde5fe7da.rem, crem_allocs = (C.long)(x.Rem), cgoAllocsUnknown
	allocsde5fe7da.Borrow(crem_allocs)

	x.refde5fe7da = refde5fe7da
	x.allocsde5fe7da = allocsde5fe7da
	return refde5fe7da, allocsde5fe7da

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x LdivT) PassValue() (C.ldiv_t, *cgoAllocMap) {
	if x.refde5fe7da != nil {
		return *x.refde5fe7da, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
func (x *LdivT) Deref() {
	...
	x.Quot = (int32)(x.refde5fe7da.quot)
	x.Rem = (int32)(x.refde5fe7da.rem)
}
...
func (x *LldivT) Ref() *C.lldiv_t {
	...
	return x.refbee7bf96
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *LldivT) Free() {
	if x != nil && x.allocsbee7bf96 != nil {
		x.allocsbee7bf96.(*cgoAllocMap).Free()
		x.refbee7bf96 = nil
	}
}

// NewLldivTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewLldivTRef(ref unsafe.Pointer) *LldivT {
	...
	obj := new(LldivT)
	obj.refbee7bf96 = (*C.lldiv_t)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *LldivT) PassRef() (*C.lldiv_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refbee7bf96 != nil {
		return x.refbee7bf96, nil
	}
	membee7bf96 := allocLldivTMemory(1)
	refbee7bf96 := (*C.lldiv_t)(membee7bf96)
	allocsbee7bf96 := new(cgoAllocMap)
	allocsbee7bf96.Add(membee7bf96)

	var cquot_allocs *cgoAllocMap
	refbee7bf96.quot, cquot_allocs = (C.longlong)(x.Quot), cgoAllocsUnknown
	allocsbee7bf96.Borrow(cquot_allocs)

	var crem_allocs *cgoAllocMap
	refbee7bf96.rem, crem_allocs = (C.longlong)(x.Rem), cgoAllocsUnknown
	allocsbee7bf96.Borrow(crem_allocs)

	x.refbee7bf96 = refbee7bf96
	x.allocsbee7bf96 = allocsbee7bf96
	return refbee7bf96, allocsbee7bf96

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x LldivT) PassValue() (C.lldiv_t, *cgoAllocMap) {
	if x.refbee7bf96 != nil {
		return *x.refbee7bf96, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
func (x *LldivT) Deref() {
	...
	x.Quot = (int64)(x.refbee7bf96.quot)
	x.Rem = (int64)(x.refbee7bf96.rem)
}

func (x _ComparFnT) PassRef() (ref *C.__compar_fn_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if _ComparFnT60E030D6Func == nil {
		_ComparFnT60E030D6Func = x
	}
	return (*C.__compar_fn_t)(C.__compar_fn_t_60e030d6), nil
}

func (x _ComparFnT) PassValue() (ref C.__compar_fn_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if _ComparFnT60E030D6Func == nil {
...
func New_ComparFnTRef(ref unsafe.Pointer) *_ComparFnT {
	return (*_ComparFnT)(ref)
}

//export _ComparFnT60E030D6
func _ComparFnT60E030D6(carg0 unsafe.Pointer, carg1 unsafe.Pointer) C.int {
	if _ComparFnT60E030D6Func != nil {
		arg060e030d6 := (unsafe.Pointer)(unsafe.Pointer(carg0))
		arg160e030d6 := (unsafe.Pointer)(unsafe.Pointer(carg1))
		ret60e030d6 := _ComparFnT60E030D6Func(arg060e030d6, arg160e030d6)
		ret, _ := (C.int)(ret60e030d6), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}

var _ComparFnT60E030D6Func _ComparFnT
...
// NewFsidTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
...
// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *FsidT) PassRef() (*C.__fsid_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref3fddfece != nil {
		return x.ref3fddfece, nil
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x FsidT) PassValue() (C.__fsid_t, *cgoAllocMap) {
	if x.ref3fddfece != nil {
		return *x.ref3fddfece, nil
	}
	ref, allocs := x.PassRef()
...
func (x *FdSet) PassRef() (*C.fd_set, *cgoAllocMap) {
	...
	var c__fds_bits_allocs *cgoAllocMap
	ref89e67f53.__fds_bits, c__fds_bits_allocs = *(*[16]C.__fd_mask)(unsafe.Pointer(&x._FdsBits)), cgoAllocsUnknown
	allocs89e67f53.Borrow(c__fds_bits_allocs)
...
func (x *FdSet) Deref() {
	...
	x._FdsBits = *(*[16]_FdMask)(unsafe.Pointer(&x.ref89e67f53.__fds_bits))
}
...
// NewSigsetTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
...
// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *SigsetT) PassRef() (*C.__sigset_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refa44732af != nil {
		return x.refa44732af, nil
	}
	mema44732af := alloc_SigsetTMemory(1)
	refa44732af := (*C.__sigset_t)(mema44732af)
	allocsa44732af := new(cgoAllocMap)
	allocsa44732af.Add(mema44732af)

	var c__val_allocs *cgoAllocMap
	refa44732af.__val, c__val_allocs = *(*[16]C.ulong)(unsafe.Pointer(&x._Val)), cgoAllocsUnknown
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x SigsetT) PassValue() (C.__sigset_t, *cgoAllocMap) {
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *SigsetT) Deref() {
	if x.refa44732af == nil {
		return
	}
	x._Val = *(*[16]uint32)(unsafe.Pointer(&x.refa44732af.__val))
}

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *_SigsetT) Ref() *C.__sigset_t {
	if x == nil {
		return nil
	}
	return x.refa44732af
...
// New_SigsetTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func New_SigsetTRef(ref unsafe.Pointer) *_SigsetT {
	if ref == nil {
		return nil
	}
	obj := new(_SigsetT)
...
// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *_SigsetT) PassRef() (*C.__sigset_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refa44732af != nil {
		return x.refa44732af, nil
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x _SigsetT) PassValue() (C.__sigset_t, *cgoAllocMap) {
	if x.refa44732af != nil {
		return *x.refa44732af, nil
	}
	ref, allocs := x.PassRef()
...
// alloc_PthreadListTMemory allocates memory for type C.__pthread_list_t in C.
// The caller is responsible for freeing the this memory via C.free.
func alloc_PthreadListTMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOf_PthreadListTValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOf_PthreadListTValue = unsafe.Sizeof([1]C.__pthread_list_t{})

// allocStruct__PthreadInternalListMemory allocates memory for type C.struct___pthread_internal_list in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct__PthreadInternalListMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct__PthreadInternalListValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfStruct__PthreadInternalListValue = unsafe.Sizeof([1]C.struct___pthread_internal_list{})

// unpackS_PthreadInternalList transforms a sliced Go data structure into plain C format.
func unpackS_PthreadInternalList(x []_PthreadInternalList) (unpacked *C.struct___pthread_internal_list, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocStruct__PthreadInternalListMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
	...
	v0 := *(*[]C.struct___pthread_internal_list)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.struct___pthread_internal_list)(h.Data)
	return
}

// packS_PthreadInternalList reads sliced Go data structure out from plain C format.
func packS_PthreadInternalList(v []_PthreadInternalList, ptr0 *C.struct___pthread_internal_list) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfStruct__PthreadInternalListValue]C.struct___pthread_internal_list)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *New_PthreadInternalListRef(unsafe.Pointer(&ptr1))
	}
}

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *_PthreadListT) Ref() *C.__pthread_list_t {
	if x == nil {
		return nil
	}
...
// New_PthreadListTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func New_PthreadListTRef(ref unsafe.Pointer) *_PthreadListT {
	if ref == nil {
		return nil
	}
	obj := new(_PthreadListT)
...
// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *_PthreadListT) PassRef() (*C.__pthread_list_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref3eec1ba6 != nil {
		return x.ref3eec1ba6, nil
	}
	mem3eec1ba6 := alloc_PthreadListTMemory(1)
	ref3eec1ba6 := (*C.__pthread_list_t)(mem3eec1ba6)
	allocs3eec1ba6 := new(cgoAllocMap)
	allocs3eec1ba6.Add(mem3eec1ba6)

	var c__prev_allocs *cgoAllocMap
	ref3eec1ba6.__prev, c__prev_allocs = unpackS_PthreadInternalList(x._Prev)
	allocs3eec1ba6.Borrow(c__prev_allocs)

	var c__next_allocs *cgoAllocMap
	ref3eec1ba6.__next, c__next_allocs = unpackS_PthreadInternalList(x._Next)
	allocs3eec1ba6.Borrow(c__next_allocs)
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x _PthreadListT) PassValue() (C.__pthread_list_t, *cgoAllocMap) {
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *_PthreadListT) Deref() {
	if x.ref3eec1ba6 == nil {
		return
	}
	packS_PthreadInternalList(x._Prev, x.ref3eec1ba6.__prev)
	packS_PthreadInternalList(x._Next, x.ref3eec1ba6.__next)
}

// alloc_PthreadSlistTMemory allocates memory for type C.__pthread_slist_t in C.
// The caller is responsible for freeing the this memory via C.free.
func alloc_PthreadSlistTMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOf_PthreadSlistTValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOf_PthreadSlistTValue = unsafe.Sizeof([1]C.__pthread_slist_t{})

// allocStruct__PthreadInternalSlistMemory allocates memory for type C.struct___pthread_internal_slist in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct__PthreadInternalSlistMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct__PthreadInternalSlistValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfStruct__PthreadInternalSlistValue = unsafe.Sizeof([1]C.struct___pthread_internal_slist{})

// unpackS_PthreadInternalSlist transforms a sliced Go data structure into plain C format.
func unpackS_PthreadInternalSlist(x []_PthreadInternalSlist) (unpacked *C.struct___pthread_internal_slist, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocStruct__PthreadInternalSlistMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
	...
	v0 := *(*[]C.struct___pthread_internal_slist)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.struct___pthread_internal_slist)(h.Data)
	return
}

// packS_PthreadInternalSlist reads sliced Go data structure out from plain C format.
func packS_PthreadInternalSlist(v []_PthreadInternalSlist, ptr0 *C.struct___pthread_internal_slist) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfStruct__PthreadInternalSlistValue]C.struct___pthread_internal_slist)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *New_PthreadInternalSlistRef(unsafe.Pointer(&ptr1))
	}
}

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *_PthreadSlistT) Ref() *C.__pthread_slist_t {
	if x == nil {
		return nil
	}
	return x.ref8e552e08
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *_PthreadSlistT) Free() {
	if x != nil && x.allocs8e552e08 != nil {
		x.allocs8e552e08.(*cgoAllocMap).Free()
		x.ref8e552e08 = nil
	}
}

// New_PthreadSlistTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func New_PthreadSlistTRef(ref unsafe.Pointer) *_PthreadSlistT {
	if ref == nil {
		return nil
	}
	obj := new(_PthreadSlistT)
	obj.ref8e552e08 = (*C.__pthread_slist_t)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *_PthreadSlistT) PassRef() (*C.__pthread_slist_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref8e552e08 != nil {
		return x.ref8e552e08, nil
	}
	mem8e552e08 := alloc_PthreadSlistTMemory(1)
	ref8e552e08 := (*C.__pthread_slist_t)(mem8e552e08)
	allocs8e552e08 := new(cgoAllocMap)
	allocs8e552e08.Add(mem8e552e08)

	var c__next_allocs *cgoAllocMap
	ref8e552e08.__next, c__next_allocs = unpackS_PthreadInternalSlist(x._Next)
	allocs8e552e08.Borrow(c__next_allocs)

	x.ref8e552e08 = ref8e552e08
	x.allocs8e552e08 = allocs8e552e08
	return ref8e552e08, allocs8e552e08

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x _PthreadSlistT) PassValue() (C.__pthread_slist_t, *cgoAllocMap) {
	if x.ref8e552e08 != nil {
		return *x.ref8e552e08, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *_PthreadSlistT) Deref() {
	if x.ref8e552e08 == nil {
		return
	}
	packS_PthreadInternalSlist(x._Next, x.ref8e552e08.__next)
}
...
func tss2RcHandlerC80E0A42(crc C.TSS2_RC) *C.char {
	if tss2RcHandlerC80E0A42Func != nil {
		...
		ret, _ := unpackArgSString(retc80e0a42)
		return ret
	}
	panic("callback func has not been set (race?)")
}
...
// NewImaxdivTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
...
// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *ImaxdivT) PassRef() (*C.imaxdiv_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref873cd79e != nil {
		return x.ref873cd79e, nil
	}
	mem873cd79e := allocImaxdivTMemory(1)
...
// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x ImaxdivT) PassValue() (C.imaxdiv_t, *cgoAllocMap) {
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *ImaxdivT) Deref() {
	if x.ref873cd79e == nil {
		return
	}
	x.Quot = (int32)(x.ref873cd79e.quot)
	x.Rem = (int32)(x.ref873cd79e.rem)
}

// allocStruct__PthreadCondSMemory allocates memory for type C.struct___pthread_cond_s in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct__PthreadCondSMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct__PthreadCondSValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfStruct__PthreadCondSValue = unsafe.Sizeof([1]C.struct___pthread_cond_s{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *_PthreadCondS) Ref() *C.struct___pthread_cond_s {
	if x == nil {
		return nil
	}
	return x.ref3517d571
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *_PthreadCondS) Free() {
	if x != nil && x.allocs3517d571 != nil {
		x.allocs3517d571.(*cgoAllocMap).Free()
		x.ref3517d571 = nil
	}
}

// New_PthreadCondSRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func New_PthreadCondSRef(ref unsafe.Pointer) *_PthreadCondS {
	if ref == nil {
		return nil
	}
	obj := new(_PthreadCondS)
	obj.ref3517d571 = (*C.struct___pthread_cond_s)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *_PthreadCondS) PassRef() (*C.struct___pthread_cond_s, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref3517d571 != nil {
		return x.ref3517d571, nil
	}
	mem3517d571 := allocStruct__PthreadCondSMemory(1)
	ref3517d571 := (*C.struct___pthread_cond_s)(mem3517d571)
	allocs3517d571 := new(cgoAllocMap)
	allocs3517d571.Add(mem3517d571)

	var cfield0_allocs *cgoAllocMap
	ref3517d571.field0, cfield0_allocs = *(*C.union_)(unsafe.Pointer(&x.Field0)), cgoAllocsUnknown
	allocs3517d571.Borrow(cfield0_allocs)

	var cfield1_allocs *cgoAllocMap
	ref3517d571.field1, cfield1_allocs = *(*C.union_)(unsafe.Pointer(&x.Field1)), cgoAllocsUnknown
	allocs3517d571.Borrow(cfield1_allocs)

	var c__g_refs_allocs *cgoAllocMap
	ref3517d571.__g_refs, c__g_refs_allocs = *(*[2]C.uint)(unsafe.Pointer(&x._GRefs)), cgoAllocsUnknown
	allocs3517d571.Borrow(c__g_refs_allocs)

	var c__g_size_allocs *cgoAllocMap
	ref3517d571.__g_size, c__g_size_allocs = *(*[2]C.uint)(unsafe.Pointer(&x._GSize)), cgoAllocsUnknown
	allocs3517d571.Borrow(c__g_size_allocs)

	var c__g1_orig_size_allocs *cgoAllocMap
	ref3517d571.__g1_orig_size, c__g1_orig_size_allocs = (C.uint)(x._G1OrigSize), cgoAllocsUnknown
	allocs3517d571.Borrow(c__g1_orig_size_allocs)

	var c__wrefs_allocs *cgoAllocMap
	ref3517d571.__wrefs, c__wrefs_allocs = (C.uint)(x._Wrefs), cgoAllocsUnknown
	allocs3517d571.Borrow(c__wrefs_allocs)

	var c__g_signals_allocs *cgoAllocMap
	ref3517d571.__g_signals, c__g_signals_allocs = *(*[2]C.uint)(unsafe.Pointer(&x._GSignals)), cgoAllocsUnknown
	allocs3517d571.Borrow(c__g_signals_allocs)

	x.ref3517d571 = ref3517d571
	x.allocs3517d571 = allocs3517d571
	return ref3517d571, allocs3517d571

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x _PthreadCondS) PassValue() (C.struct___pthread_cond_s, *cgoAllocMap) {
	if x.ref3517d571 != nil {
		return *x.ref3517d571, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *_PthreadCondS) Deref() {
	if x.ref3517d571 == nil {
		return
	}
	x.Field0 = *(*C.union_)(unsafe.Pointer(&x.ref3517d571.field0))
	x.Field1 = *(*C.union_)(unsafe.Pointer(&x.ref3517d571.field1))
	x._GRefs = *(*[2]uint32)(unsafe.Pointer(&x.ref3517d571.__g_refs))
	x._GSize = *(*[2]uint32)(unsafe.Pointer(&x.ref3517d571.__g_size))
	x._G1OrigSize = (uint32)(x.ref3517d571.__g1_orig_size)
	x._Wrefs = (uint32)(x.ref3517d571.__wrefs)
	x._GSignals = *(*[2]uint32)(unsafe.Pointer(&x.ref3517d571.__g_signals))
}

// allocStruct__PthreadMutexSMemory allocates memory for type C.struct___pthread_mutex_s in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct__PthreadMutexSMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct__PthreadMutexSValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfStruct__PthreadMutexSValue = unsafe.Sizeof([1]C.struct___pthread_mutex_s{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *_PthreadMutexS) Ref() *C.struct___pthread_mutex_s {
	if x == nil {
		return nil
	}
	return x.ref58941059
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *_PthreadMutexS) Free() {
	if x != nil && x.allocs58941059 != nil {
		x.allocs58941059.(*cgoAllocMap).Free()
		x.ref58941059 = nil
	}
}

// New_PthreadMutexSRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func New_PthreadMutexSRef(ref unsafe.Pointer) *_PthreadMutexS {
	if ref == nil {
		return nil
	}
	obj := new(_PthreadMutexS)
	obj.ref58941059 = (*C.struct___pthread_mutex_s)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *_PthreadMutexS) PassRef() (*C.struct___pthread_mutex_s, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref58941059 != nil {
		return x.ref58941059, nil
	}
	mem58941059 := allocStruct__PthreadMutexSMemory(1)
	ref58941059 := (*C.struct___pthread_mutex_s)(mem58941059)
	allocs58941059 := new(cgoAllocMap)
	allocs58941059.Add(mem58941059)

	var c__lock_allocs *cgoAllocMap
	ref58941059.__lock, c__lock_allocs = (C.int)(x._Lock), cgoAllocsUnknown
	allocs58941059.Borrow(c__lock_allocs)

	var c__count_allocs *cgoAllocMap
	ref58941059.__count, c__count_allocs = (C.uint)(x._Count), cgoAllocsUnknown
	allocs58941059.Borrow(c__count_allocs)

	var c__owner_allocs *cgoAllocMap
	ref58941059.__owner, c__owner_allocs = (C.int)(x._Owner), cgoAllocsUnknown
	allocs58941059.Borrow(c__owner_allocs)

	var c__nusers_allocs *cgoAllocMap
	ref58941059.__nusers, c__nusers_allocs = (C.uint)(x._Nusers), cgoAllocsUnknown
	allocs58941059.Borrow(c__nusers_allocs)

	var c__kind_allocs *cgoAllocMap
	ref58941059.__kind, c__kind_allocs = (C.int)(x._Kind), cgoAllocsUnknown
	allocs58941059.Borrow(c__kind_allocs)

	var c__spins_allocs *cgoAllocMap
	ref58941059.__spins, c__spins_allocs = (C.short)(x._Spins), cgoAllocsUnknown
	allocs58941059.Borrow(c__spins_allocs)

	var c__elision_allocs *cgoAllocMap
	ref58941059.__elision, c__elision_allocs = (C.short)(x._Elision), cgoAllocsUnknown
	allocs58941059.Borrow(c__elision_allocs)

	var c__list_allocs *cgoAllocMap
	ref58941059.__list, c__list_allocs = x._List.PassValue()
	allocs58941059.Borrow(c__list_allocs)

	x.ref58941059 = ref58941059
	x.allocs58941059 = allocs58941059
	return ref58941059, allocs58941059

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x _PthreadMutexS) PassValue() (C.struct___pthread_mutex_s, *cgoAllocMap) {
	if x.ref58941059 != nil {
		return *x.ref58941059, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *_PthreadMutexS) Deref() {
	if x.ref58941059 == nil {
		return
	}
	x._Lock = (int32)(x.ref58941059.__lock)
	x._Count = (uint32)(x.ref58941059.__count)
	x._Owner = (int32)(x.ref58941059.__owner)
	x._Nusers = (uint32)(x.ref58941059.__nusers)
	x._Kind = (int32)(x.ref58941059.__kind)
	x._Spins = (int16)(x.ref58941059.__spins)
	x._Elision = (int16)(x.ref58941059.__elision)
	x._List = *New_PthreadListTRef(unsafe.Pointer(&x.ref58941059.__list))
}

// allocStruct__PthreadRwlockArchTMemory allocates memory for type C.struct___pthread_rwlock_arch_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct__PthreadRwlockArchTMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct__PthreadRwlockArchTValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfStruct__PthreadRwlockArchTValue = unsafe.Sizeof([1]C.struct___pthread_rwlock_arch_t{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *_PthreadRwlockArchT) Ref() *C.struct___pthread_rwlock_arch_t {
	if x == nil {
		return nil
	}
	return x.refb4dcb58a
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *_PthreadRwlockArchT) Free() {
	if x != nil && x.allocsb4dcb58a != nil {
		x.allocsb4dcb58a.(*cgoAllocMap).Free()
		x.refb4dcb58a = nil
	}
}

// New_PthreadRwlockArchTRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func New_PthreadRwlockArchTRef(ref unsafe.Pointer) *_PthreadRwlockArchT {
	if ref == nil {
		return nil
	}
	obj := new(_PthreadRwlockArchT)
	obj.refb4dcb58a = (*C.struct___pthread_rwlock_arch_t)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *_PthreadRwlockArchT) PassRef() (*C.struct___pthread_rwlock_arch_t, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refb4dcb58a != nil {
		return x.refb4dcb58a, nil
	}
	memb4dcb58a := allocStruct__PthreadRwlockArchTMemory(1)
	refb4dcb58a := (*C.struct___pthread_rwlock_arch_t)(memb4dcb58a)
	allocsb4dcb58a := new(cgoAllocMap)
	allocsb4dcb58a.Add(memb4dcb58a)

	var c__readers_allocs *cgoAllocMap
	refb4dcb58a.__readers, c__readers_allocs = (C.uint)(x._Readers), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__readers_allocs)

	var c__writers_allocs *cgoAllocMap
	refb4dcb58a.__writers, c__writers_allocs = (C.uint)(x._Writers), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__writers_allocs)

	var c__wrphase_futex_allocs *cgoAllocMap
	refb4dcb58a.__wrphase_futex, c__wrphase_futex_allocs = (C.uint)(x._WrphaseFutex), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__wrphase_futex_allocs)

	var c__writers_futex_allocs *cgoAllocMap
	refb4dcb58a.__writers_futex, c__writers_futex_allocs = (C.uint)(x._WritersFutex), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__writers_futex_allocs)

	var c__pad3_allocs *cgoAllocMap
	refb4dcb58a.__pad3, c__pad3_allocs = (C.uint)(x._Pad3), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__pad3_allocs)

	var c__pad4_allocs *cgoAllocMap
	refb4dcb58a.__pad4, c__pad4_allocs = (C.uint)(x._Pad4), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__pad4_allocs)

	var c__cur_writer_allocs *cgoAllocMap
	refb4dcb58a.__cur_writer, c__cur_writer_allocs = (C.int)(x._CurWriter), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__cur_writer_allocs)

	var c__shared_allocs *cgoAllocMap
	refb4dcb58a.__shared, c__shared_allocs = (C.int)(x._Shared), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__shared_allocs)

	var c__rwelision_allocs *cgoAllocMap
	refb4dcb58a.__rwelision, c__rwelision_allocs = (C.schar)(x._Rwelision), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__rwelision_allocs)

	var c__pad1_allocs *cgoAllocMap
	refb4dcb58a.__pad1, c__pad1_allocs = *(*[7]C.uchar)(unsafe.Pointer(&x._Pad1)), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__pad1_allocs)

	var c__pad2_allocs *cgoAllocMap
	refb4dcb58a.__pad2, c__pad2_allocs = (C.ulong)(x._Pad2), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__pad2_allocs)

	var c__flags_allocs *cgoAllocMap
	refb4dcb58a.__flags, c__flags_allocs = (C.uint)(x._Flags), cgoAllocsUnknown
	allocsb4dcb58a.Borrow(c__flags_allocs)

	x.refb4dcb58a = refb4dcb58a
	x.allocsb4dcb58a = allocsb4dcb58a
	return refb4dcb58a, allocsb4dcb58a

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x _PthreadRwlockArchT) PassValue() (C.struct___pthread_rwlock_arch_t, *cgoAllocMap) {
	if x.refb4dcb58a != nil {
		return *x.refb4dcb58a, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *_PthreadRwlockArchT) Deref() {
	if x.refb4dcb58a == nil {
		return
	}
	x._Readers = (uint32)(x.refb4dcb58a.__readers)
	x._Writers = (uint32)(x.refb4dcb58a.__writers)
	x._WrphaseFutex = (uint32)(x.refb4dcb58a.__wrphase_futex)
	x._WritersFutex = (uint32)(x.refb4dcb58a.__writers_futex)
	x._Pad3 = (uint32)(x.refb4dcb58a.__pad3)
	x._Pad4 = (uint32)(x.refb4dcb58a.__pad4)
	x._CurWriter = (int32)(x.refb4dcb58a.__cur_writer)
	x._Shared = (int32)(x.refb4dcb58a.__shared)
	x._Rwelision = (int8)(x.refb4dcb58a.__rwelision)
	x._Pad1 = *(*[7]byte)(unsafe.Pointer(&x.refb4dcb58a.__pad1))
	x._Pad2 = (uint32)(x.refb4dcb58a.__pad2)
	x._Flags = (uint32)(x.refb4dcb58a.__flags)
}
...
func (x *Drand48Data) Ref() *C.struct_drand48_data {
	...
	return x.ref34d792ac
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Drand48Data) Free() {
	if x != nil && x.allocs34d792ac != nil {
		x.allocs34d792ac.(*cgoAllocMap).Free()
		x.ref34d792ac = nil
	}
}

// NewDrand48DataRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewDrand48DataRef(ref unsafe.Pointer) *Drand48Data {
	...
	obj := new(Drand48Data)
	obj.ref34d792ac = (*C.struct_drand48_data)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Drand48Data) PassRef() (*C.struct_drand48_data, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref34d792ac != nil {
		return x.ref34d792ac, nil
	}
	mem34d792ac := allocStructDrand48DataMemory(1)
	ref34d792ac := (*C.struct_drand48_data)(mem34d792ac)
	allocs34d792ac := new(cgoAllocMap)
	allocs34d792ac.Add(mem34d792ac)

	var c__x_allocs *cgoAllocMap
	ref34d792ac.__x, c__x_allocs = *(*[3]C.ushort)(unsafe.Pointer(&x._X)), cgoAllocsUnknown
	allocs34d792ac.Borrow(c__x_allocs)

	var c__old_x_allocs *cgoAllocMap
	ref34d792ac.__old_x, c__old_x_allocs = *(*[3]C.ushort)(unsafe.Pointer(&x._OldX)), cgoAllocsUnknown
	allocs34d792ac.Borrow(c__old_x_allocs)

	var c__c_allocs *cgoAllocMap
	ref34d792ac.__c, c__c_allocs = (C.ushort)(x._C), cgoAllocsUnknown
	allocs34d792ac.Borrow(c__c_allocs)

	var c__init_allocs *cgoAllocMap
	ref34d792ac.__init, c__init_allocs = (C.ushort)(x._Init), cgoAllocsUnknown
	allocs34d792ac.Borrow(c__init_allocs)

	var c__a_allocs *cgoAllocMap
	ref34d792ac.__a, c__a_allocs = (C.ulonglong)(x._A), cgoAllocsUnknown
	allocs34d792ac.Borrow(c__a_allocs)

	x.ref34d792ac = ref34d792ac
	x.allocs34d792ac = allocs34d792ac
	return ref34d792ac, allocs34d792ac

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Drand48Data) PassValue() (C.struct_drand48_data, *cgoAllocMap) {
	if x.ref34d792ac != nil {
		return *x.ref34d792ac, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *Drand48Data) Deref() {
	if x.ref34d792ac == nil {
		return
	}
	x._X = *(*[3]uint16)(unsafe.Pointer(&x.ref34d792ac.__x))
	x._OldX = *(*[3]uint16)(unsafe.Pointer(&x.ref34d792ac.__old_x))
	x._C = (uint16)(x.ref34d792ac.__c)
	x._Init = (uint16)(x.ref34d792ac.__init)
	x._A = (uint64)(x.ref34d792ac.__a)
}
...
func (x *RandomData) Free() {
	if x != nil && x.allocsb9fde78 != nil {
		x.allocsb9fde78.(*cgoAllocMap).Free()
		x.refb9fde78 = nil
	}
}

// NewRandomDataRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewRandomDataRef(ref unsafe.Pointer) *RandomData {
	...
	obj := new(RandomData)
	obj.refb9fde78 = (*C.struct_random_data)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *RandomData) PassRef() (*C.struct_random_data, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refb9fde78 != nil {
		return x.refb9fde78, nil
	}
	memb9fde78 := allocStructRandomDataMemory(1)
	refb9fde78 := (*C.struct_random_data)(memb9fde78)
	allocsb9fde78 := new(cgoAllocMap)
	allocsb9fde78.Add(memb9fde78)

	var cfptr_allocs *cgoAllocMap
	refb9fde78.fptr, cfptr_allocs = copyPInt32TBytes((*sliceHeader)(unsafe.Pointer(&x.Fptr)))
	allocsb9fde78.Borrow(cfptr_allocs)

	var crptr_allocs *cgoAllocMap
	refb9fde78.rptr, crptr_allocs = copyPInt32TBytes((*sliceHeader)(unsafe.Pointer(&x.Rptr)))
	allocsb9fde78.Borrow(crptr_allocs)

	var cstate_allocs *cgoAllocMap
	refb9fde78.state, cstate_allocs = copyPInt32TBytes((*sliceHeader)(unsafe.Pointer(&x.State)))
	allocsb9fde78.Borrow(cstate_allocs)

	var crand_type_allocs *cgoAllocMap
	refb9fde78.rand_type, crand_type_allocs = (C.int)(x.RandType), cgoAllocsUnknown
	allocsb9fde78.Borrow(crand_type_allocs)

	var crand_deg_allocs *cgoAllocMap
	refb9fde78.rand_deg, crand_deg_allocs = (C.int)(x.RandDeg), cgoAllocsUnknown
	allocsb9fde78.Borrow(crand_deg_allocs)

	var crand_sep_allocs *cgoAllocMap
	refb9fde78.rand_sep, crand_sep_allocs = (C.int)(x.RandSep), cgoAllocsUnknown
	allocsb9fde78.Borrow(crand_sep_allocs)

	var cend_ptr_allocs *cgoAllocMap
	refb9fde78.end_ptr, cend_ptr_allocs = copyPInt32TBytes((*sliceHeader)(unsafe.Pointer(&x.EndPtr)))
	allocsb9fde78.Borrow(cend_ptr_allocs)

	x.refb9fde78 = refb9fde78
	x.allocsb9fde78 = allocsb9fde78
	return refb9fde78, allocsb9fde78

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x RandomData) PassValue() (C.struct_random_data, *cgoAllocMap) {
	if x.refb9fde78 != nil {
		return *x.refb9fde78, nil
	}
	ref, allocs := x.PassRef()
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *RandomData) Deref() {
	if x.refb9fde78 == nil {
		return
	}
	hxf547023 := (*sliceHeader)(unsafe.Pointer(&x.Fptr))
	hxf547023.Data = unsafe.Pointer(x.refb9fde78.fptr)
	hxf547023.Cap = 0x7fffffff
	// hxf547023.Len = ?

	hxf5ebb88 := (*sliceHeader)(unsafe.Pointer(&x.Rptr))
	hxf5ebb88.Data = unsafe.Pointer(x.refb9fde78.rptr)
	hxf5ebb88.Cap = 0x7fffffff
	// hxf5ebb88.Len = ?

	hxff20e84 := (*sliceHeader)(unsafe.Pointer(&x.State))
	hxff20e84.Data = unsafe.Pointer(x.refb9fde78.state)
	hxff20e84.Cap = 0x7fffffff
	// hxff20e84.Len = ?

	x.RandType = (int32)(x.refb9fde78.rand_type)
	x.RandDeg = (int32)(x.refb9fde78.rand_deg)
	x.RandSep = (int32)(x.refb9fde78.rand_sep)
	hxfa26a4d := (*sliceHeader)(unsafe.Pointer(&x.EndPtr))
	hxfa26a4d.Data = unsafe.Pointer(x.refb9fde78.end_ptr)
...
func (x *Timespec) Ref() *C.struct_timespec {
	...
	return x.refd3d35df8
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Timespec) Free() {
	if x != nil && x.allocsd3d35df8 != nil {
		x.allocsd3d35df8.(*cgoAllocMap).Free()
		x.refd3d35df8 = nil
	}
}

// NewTimespecRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewTimespecRef(ref unsafe.Pointer) *Timespec {
	...
	obj := new(Timespec)
	obj.refd3d35df8 = (*C.struct_timespec)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Timespec) PassRef() (*C.struct_timespec, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refd3d35df8 != nil {
		return x.refd3d35df8, nil
	}
	memd3d35df8 := allocStructTimespecMemory(1)
	refd3d35df8 := (*C.struct_timespec)(memd3d35df8)
	allocsd3d35df8 := new(cgoAllocMap)
	allocsd3d35df8.Add(memd3d35df8)

	var ctv_sec_allocs *cgoAllocMap
	refd3d35df8.tv_sec, ctv_sec_allocs = (C.__time_t)(x.TvSec), cgoAllocsUnknown
	allocsd3d35df8.Borrow(ctv_sec_allocs)

	var ctv_nsec_allocs *cgoAllocMap
	refd3d35df8.tv_nsec, ctv_nsec_allocs = (C.__syscall_slong_t)(x.TvNsec), cgoAllocsUnknown
	allocsd3d35df8.Borrow(ctv_nsec_allocs)

	x.refd3d35df8 = refd3d35df8
	x.allocsd3d35df8 = allocsd3d35df8
	return refd3d35df8, allocsd3d35df8

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Timespec) PassValue() (C.struct_timespec, *cgoAllocMap) {
	if x.refd3d35df8 != nil {
		return *x.refd3d35df8, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *Timespec) Deref() {
	if x.refd3d35df8 == nil {
		return
	}
	x.TvSec = (_TimeT)(x.refd3d35df8.tv_sec)
	x.TvNsec = (_SyscallSlongT)(x.refd3d35df8.tv_nsec)
}
...
func (x *Timeval) Ref() *C.struct_timeval {
	...
	return x.ref260d2a7d
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Timeval) Free() {
	if x != nil && x.allocs260d2a7d != nil {
		x.allocs260d2a7d.(*cgoAllocMap).Free()
		x.ref260d2a7d = nil
	}
}

// NewTimevalRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewTimevalRef(ref unsafe.Pointer) *Timeval {
	...
	obj := new(Timeval)
	obj.ref260d2a7d = (*C.struct_timeval)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Timeval) PassRef() (*C.struct_timeval, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref260d2a7d != nil {
		return x.ref260d2a7d, nil
	}
	mem260d2a7d := allocStructTimevalMemory(1)
	ref260d2a7d := (*C.struct_timeval)(mem260d2a7d)
	allocs260d2a7d := new(cgoAllocMap)
	allocs260d2a7d.Add(mem260d2a7d)

	var ctv_sec_allocs *cgoAllocMap
	ref260d2a7d.tv_sec, ctv_sec_allocs = (C.__time_t)(x.TvSec), cgoAllocsUnknown
	allocs260d2a7d.Borrow(ctv_sec_allocs)

	var ctv_usec_allocs *cgoAllocMap
	ref260d2a7d.tv_usec, ctv_usec_allocs = (C.__suseconds_t)(x.TvUsec), cgoAllocsUnknown
	allocs260d2a7d.Borrow(ctv_usec_allocs)

	x.ref260d2a7d = ref260d2a7d
	x.allocs260d2a7d = allocs260d2a7d
	return ref260d2a7d, allocs260d2a7d

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Timeval) PassValue() (C.struct_timeval, *cgoAllocMap) {
	if x.ref260d2a7d != nil {
		return *x.ref260d2a7d, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
// Deref uses the underlying reference to C object and fills the wrapping struct with values.
// Do not forget to call this method whether you get a struct for C object and want to read its values.
func (x *Timeval) Deref() {
	if x.ref260d2a7d == nil {
		return
	}
	x.TvSec = (_TimeT)(x.ref260d2a7d.tv_sec)
	x.TvUsec = (_SusecondsT)(x.ref260d2a7d.tv_usec)
}
...
// unpackArgSTss2AbiVersion transforms a sliced Go data structure into plain C format.
func unpackArgSTss2AbiVersion(x []Tss2AbiVersion) (unpacked *C.TSS2_ABI_VERSION, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocTss2AbiVersionMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
	...
	v0 := *(*[]C.TSS2_ABI_VERSION)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.TSS2_ABI_VERSION)(h.Data)
	return
}

// packSTss2AbiVersion reads sliced Go data structure out from plain C format.
func packSTss2AbiVersion(v []Tss2AbiVersion, ptr0 *C.TSS2_ABI_VERSION) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfTss2AbiVersionValue]C.TSS2_ABI_VERSION)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewTss2AbiVersionRef(unsafe.Pointer(&ptr1))
	}
}
...
// allocPTss2SysContextMemory allocates memory for type *C.TSS2_SYS_CONTEXT in C.
// The caller is responsible for freeing the this memory via C.free.
func allocPTss2SysContextMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfPTss2SysContextValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfPTss2SysContextValue = unsafe.Sizeof([1]*C.TSS2_SYS_CONTEXT{})

// unpackArgSSTss2SysContext transforms a sliced Go data structure into plain C format.
func unpackArgSSTss2SysContext(x [][]Tss2SysContext) (unpacked **C.TSS2_SYS_CONTEXT, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocPTss2SysContextMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
	...
	v0 := *(*[]*C.TSS2_SYS_CONTEXT)(unsafe.Pointer(h0))
	for i0 := range x {
		h := (*sliceHeader)(unsafe.Pointer(&x[i0]))
		v0[i0] = (*C.TSS2_SYS_CONTEXT)(h.Data)
	}
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (**C.TSS2_SYS_CONTEXT)(h.Data)
	return
}

// packSSTss2SysContext reads sliced Go data structure out from plain C format.
func packSSTss2SysContext(v [][]Tss2SysContext, ptr0 **C.TSS2_SYS_CONTEXT) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]*C.TSS2_SYS_CONTEXT)(unsafe.Pointer(ptr0)))[i0]
		hxf03a9a7 := (*sliceHeader)(unsafe.Pointer(&v[i0]))
		hxf03a9a7.Data = unsafe.Pointer(ptr1)
...
// allocPFapiContextMemory allocates memory for type *C.FAPI_CONTEXT in C.
// The caller is responsible for freeing the this memory via C.free.
func allocPFapiContextMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfPFapiContextValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfPFapiContextValue = unsafe.Sizeof([1]*C.FAPI_CONTEXT{})

// unpackArgSSFapiContext transforms a sliced Go data structure into plain C format.
func unpackArgSSFapiContext(x [][]FapiContext) (unpacked **C.FAPI_CONTEXT, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocPFapiContextMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
	...
	v0 := *(*[]*C.FAPI_CONTEXT)(unsafe.Pointer(h0))
	for i0 := range x {
		h := (*sliceHeader)(unsafe.Pointer(&x[i0]))
		v0[i0] = (*C.FAPI_CONTEXT)(h.Data)
	}
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (**C.FAPI_CONTEXT)(h.Data)
	return
}

// packSSFapiContext reads sliced Go data structure out from plain C format.
func packSSFapiContext(v [][]FapiContext, ptr0 **C.FAPI_CONTEXT) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]*C.FAPI_CONTEXT)(unsafe.Pointer(ptr0)))[i0]
		hxf8aebb5 := (*sliceHeader)(unsafe.Pointer(&v[i0]))
		hxf8aebb5.Data = unsafe.Pointer(ptr1)
		hxf8aebb5.Cap = 0x7fffffff
		// hxf8aebb5.Len = ?
	}
}

// copyPFapiContextBytes copies the data from Go slice as *C.FAPI_CONTEXT.
func copyPFapiContextBytes(slice *sliceHeader) (*C.FAPI_CONTEXT, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	mem0 := unsafe.Pointer(C.CBytes(*(*[]byte)(unsafe.Pointer(&sliceHeader{
		Data: slice.Data,
		Len:  int(sizeOfFapiContextValue) * slice.Len,
		Cap:  int(sizeOfFapiContextValue) * slice.Len,
	}))))
	allocs.Add(mem0)

	return (*C.FAPI_CONTEXT)(mem0), allocs
}

// copyPFapiPollHandleBytes copies the data from Go slice as *C.FAPI_POLL_HANDLE.
func copyPFapiPollHandleBytes(slice *sliceHeader) (*C.FAPI_POLL_HANDLE, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	mem0 := unsafe.Pointer(C.CBytes(*(*[]byte)(unsafe.Pointer(&sliceHeader{
		Data: slice.Data,
		Len:  int(sizeOfFapiPollHandleValue) * slice.Len,
		Cap:  int(sizeOfFapiPollHandleValue) * slice.Len,
	}))))
	allocs.Add(mem0)

	return (*C.FAPI_POLL_HANDLE)(mem0), allocs
}

// allocFapiPollHandleMemory allocates memory for type C.FAPI_POLL_HANDLE in C.
// The caller is responsible for freeing the this memory via C.free.
func allocFapiPollHandleMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfFapiPollHandleValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfFapiPollHandleValue = unsafe.Sizeof([1]C.FAPI_POLL_HANDLE{})
...
// copyPUint32TBytes copies the data from Go slice as *C.uint32_t.
func copyPUint32TBytes(slice *sliceHeader) (*C.uint32_t, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	mem0 := unsafe.Pointer(C.CBytes(*(*[]byte)(unsafe.Pointer(&sliceHeader{
		Data: slice.Data,
		Len:  int(sizeOfUint32TValue) * slice.Len,
		Cap:  int(sizeOfUint32TValue) * slice.Len,
	}))))
	allocs.Add(mem0)
...
// allocUint32TMemory allocates memory for type C.uint32_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocUint32TMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfUint32TValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfUint32TValue = unsafe.Sizeof([1]C.uint32_t{})
...
// copyPTpmuEncryptedSecretBytes copies the data from Go slice as *C.TPMU_ENCRYPTED_SECRET.
func copyPTpmuEncryptedSecretBytes(slice *sliceHeader) (*C.TPMU_ENCRYPTED_SECRET, *cgoAllocMap) {
	allocs := new(cgoAllocMap)
	defer runtime.SetFinalizer(allocs, func(a *cgoAllocMap) {
		go a.Free()
	})
	...
	mem0 := unsafe.Pointer(C.CBytes(*(*[]byte)(unsafe.Pointer(&sliceHeader{
		Data: slice.Data,
		Len:  int(sizeOfTpmuEncryptedSecretValue) * slice.Len,
		Cap:  int(sizeOfTpmuEncryptedSecretValue) * slice.Len,
	}))))
	allocs.Add(mem0)

	return (*C.TPMU_ENCRYPTED_SECRET)(mem0), allocs
}

// allocTpmuEncryptedSecretMemory allocates memory for type C.TPMU_ENCRYPTED_SECRET in C.
// The caller is responsible for freeing the this memory via C.free.
func allocTpmuEncryptedSecretMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfTpmuEncryptedSecretValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfTpmuEncryptedSecretValue = unsafe.Sizeof([1]C.TPMU_ENCRYPTED_SECRET{})
...
// unpackArgSRandomData transforms a sliced Go data structure into plain C format.
func unpackArgSRandomData(x []RandomData) (unpacked *C.struct_random_data, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocStructRandomDataMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
	...
	v0 := *(*[]C.struct_random_data)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.struct_random_data)(h.Data)
	return
}

// packSRandomData reads sliced Go data structure out from plain C format.
func packSRandomData(v []RandomData, ptr0 *C.struct_random_data) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfStructRandomDataValue]C.struct_random_data)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewRandomDataRef(unsafe.Pointer(&ptr1))
	}
}
...
// unpackArgSDrand48Data transforms a sliced Go data structure into plain C format.
func unpackArgSDrand48Data(x []Drand48Data) (unpacked *C.struct_drand48_data, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocStructDrand48DataMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
	...
	v0 := *(*[]C.struct_drand48_data)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.struct_drand48_data)(h.Data)
	return
}

// packSDrand48Data reads sliced Go data structure out from plain C format.
func packSDrand48Data(v []Drand48Data, ptr0 *C.struct_drand48_data) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfStructDrand48DataValue]C.struct_drand48_data)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewDrand48DataRef(unsafe.Pointer(&ptr1))
	}
}
...
// unpackArgSTimeval transforms a sliced Go data structure into plain C format.
func unpackArgSTimeval(x []Timeval) (unpacked *C.struct_timeval, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocStructTimevalMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
	...
	v0 := *(*[]C.struct_timeval)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.struct_timeval)(h.Data)
	return
}

// packSTimeval reads sliced Go data structure out from plain C format.
func packSTimeval(v []Timeval, ptr0 *C.struct_timeval) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfStructTimevalValue]C.struct_timeval)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewTimevalRef(unsafe.Pointer(&ptr1))
	}
}
...
func unpackArgSTimespec(x []Timespec) (unpacked *C.struct_timespec, allocs *cgoAllocMap) {
	...
	len0 := len(x)
	mem0 := allocStructTimespecMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: mem0,
		Cap:  len0,
...
func packSTimespec(v []Timespec, ptr0 *C.struct_timespec) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfStructTimespecValue]C.struct_timespec)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewTimespecRef(unsafe.Pointer(&ptr1))
	}
}

// unpackArgS_SigsetT transforms a sliced Go data structure into plain C format.
func unpackArgS_SigsetT(x []_SigsetT) (unpacked *C.__sigset_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	v0 := *(*[]C.__sigset_t)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.__sigset_t)(h.Data)
	return
}

// packS_SigsetT reads sliced Go data structure out from plain C format.
func packS_SigsetT(v []_SigsetT, ptr0 *C.__sigset_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOf_SigsetTValue]C.__sigset_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *New_SigsetTRef(unsafe.Pointer(&ptr1))
	}
}
...
func packSSTss2TctiInfo(v [][]Tss2TctiInfo, ptr0 **C.TSS2_TCTI_INFO) {
	...
	for i0 := range v {
		...
		for i1 := range v[i0] {
			ptr2 := (*(*[m / sizeOfTss2TctiInfoValue]C.TSS2_TCTI_INFO)(unsafe.Pointer(ptr1)))[i1]
			v[i0][i1] = *NewTss2TctiInfoRef(unsafe.Pointer(&ptr2))
		}
	}
}
...
// unpackArgSS_GwcharT transforms a sliced Go data structure into plain C format.
func unpackArgSS_GwcharT(x [][]_GwcharT) (unpacked **C.__gwchar_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
...
// packSS_GwcharT reads sliced Go data structure out from plain C format.
func packSS_GwcharT(v [][]_GwcharT, ptr0 **C.__gwchar_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]*C.__gwchar_t)(unsafe.Pointer(ptr0)))[i0]
		hxf2b7090 := (*sliceHeader)(unsafe.Pointer(&v[i0]))
		hxf2b7090.Data = unsafe.Pointer(ptr1)
