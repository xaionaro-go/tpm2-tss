...
unsigned int Fapi_CB_Auth_4bc69268(char* objectPath, char* description, char** auth, void* userData) {
	return fapiCbAuth4BC69268(objectPath, description, auth, userData);
}

unsigned int Fapi_CB_Branch_a8bbee51(char* objectPath, char* description, char** branchNames, unsigned long int numBranches, unsigned long int* selectedBranch, void* userData) {
	return fapiCbBranchA8BBEE51(objectPath, description, branchNames, numBranches, selectedBranch, userData);
}

unsigned int Fapi_CB_Sign_2c66b3cf(char* objectPath, char* description, char* publicKey, char* publicKeyHint, unsigned int hashAlg, unsigned char* dataToSign, unsigned long int dataToSignSize, unsigned char** signature, unsigned long int* signatureSize, void* userData) {
	return fapiCbSign2C66B3CF(objectPath, description, publicKey, publicKeyHint, hashAlg, dataToSign, dataToSignSize, signature, signatureSize, userData);
}

unsigned int Fapi_CB_PolicyAction_d83965a7(char* objectPath, char* action, void* userData) {
	return fapiCbPolicyactionD83965A7(objectPath, action, userData);
}
