...
func fapiCbAuth4BC69268(ccontext *C.FAPI_CONTEXT, cdescription *C.char, cauth **C.char, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbAuth4BC69268Func != nil {
		context4bc69268 := (*FapiContext)(unsafe.Pointer(ccontext))
...
func fapiCbBranchA8BBEE51(ccontext *C.FAPI_CONTEXT, cdescription *C.char, cbranchnames **C.char, cnumbranches C.size_t, cselectedbranch *C.size_t, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbBranchA8BBEE51Func != nil {
		contexta8bbee51 := (*FapiContext)(unsafe.Pointer(ccontext))
		...
		hxf2fab0d := (*sliceHeader)(unsafe.Pointer(&selectedbrancha8bbee51))
		hxf2fab0d.Data = unsafe.Pointer(cselectedbranch)
...
func fapiCbSign2C66B3CF(ccontext *C.FAPI_CONTEXT, cdescription *C.char, cpublickey *C.char, cpublickeyhint *C.char, chashalg C.uint32_t, cdatatosign *C.uint8_t, cdatatosignsize C.size_t, csignature **C.uint8_t, csignaturesize *C.size_t, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbSign2C66B3CFFunc != nil {
		context2c66b3cf := (*FapiContext)(unsafe.Pointer(ccontext))
		...
		hxf69fe70 := (*sliceHeader)(unsafe.Pointer(&datatosign2c66b3cf))
		hxf69fe70.Data = unsafe.Pointer(cdatatosign)
		...
		hxf3b8dbd := (*sliceHeader)(unsafe.Pointer(&signaturesize2c66b3cf))
		hxf3b8dbd.Data = unsafe.Pointer(csignaturesize)
...
func fapiCbPolicyactionD83965A7(ccontext *C.FAPI_CONTEXT, caction *C.char, cuserdata unsafe.Pointer) C.TSS2_RC {
	if fapiCbPolicyactionD83965A7Func != nil {
		contextd83965a7 := (*FapiContext)(unsafe.Pointer(ccontext))
...
func (x *RandomData) Deref() {
	...
	hxf7a6dff := (*sliceHeader)(unsafe.Pointer(&x.Fptr))
	hxf7a6dff.Data = unsafe.Pointer(x.refb9fde78.fptr)
	hxf7a6dff.Cap = 0x7fffffff
	// hxf7a6dff.Len = ?

	hxfe48d67 := (*sliceHeader)(unsafe.Pointer(&x.Rptr))
	hxfe48d67.Data = unsafe.Pointer(x.refb9fde78.rptr)
	hxfe48d67.Cap = 0x7fffffff
	// hxfe48d67.Len = ?

	hxf4171bf := (*sliceHeader)(unsafe.Pointer(&x.State))
	hxf4171bf.Data = unsafe.Pointer(x.refb9fde78.state)
	...
	hxf058b18 := (*sliceHeader)(unsafe.Pointer(&x.EndPtr))
	hxf058b18.Data = unsafe.Pointer(x.refb9fde78.end_ptr)
...
// unpackArgSPTss2TctiInfo transforms a sliced Go data structure into plain C format.
func unpackArgSPTss2TctiInfo(x []*Tss2TctiInfo) (unpacked **C.TSS2_TCTI_INFO, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
...
// packSPTss2TctiInfo reads sliced Go data structure out from plain C format.
func packSPTss2TctiInfo(v []*Tss2TctiInfo, ptr0 **C.TSS2_TCTI_INFO) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]*C.TSS2_TCTI_INFO)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = NewTss2TctiInfoRef(unsafe.Pointer(ptr1))
	}
}
